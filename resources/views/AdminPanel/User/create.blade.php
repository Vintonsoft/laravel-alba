...
@section('content')
    <div class="row mt-4 mb-2 me-0 ms-0">
        <div class="col-lg-8 col-6">
            <h6 class="mb-0">Üyeler / <small class="text-secondary">Yeni Ekle</small></h6>
    ...
    <div class="m-2 p-4 bg-white rounded shadow-sm">
        <div class="row mb-2 border-bottom border-light border-2">
            <div class="col-lg-4 h5">Yeni Üye Ekle</div>
            ...
            <div class="tab-content pt-4">
                <div class="tab-pane fade show active" id="info" role="tabpanel">
                    <div class="input-group mb-0 mb-lg-3 align-items-center">
                        ...
                        <div class="col-lg-3 col-12 pt-2 pt-lg-0 pb-2 pb-lg-0">
                            <select name="role" class="form-select text-secondary" required>
                                ...
                                <option value="1" @if(old('role') == 1) selected @endif>Yönetici</option>
                                <option value="2" @if(old('role') == 2) selected @endif>Üye</option>
                            </select>
                        </div>
                    </div>
                    <div class="input-group mb-0 mb-lg-3 align-items-center">
                        <label class="col-lg-3 col-12 align-self-center fw-bold">Ad : </label>
                        <div class="col-lg-4 col-12 pt-2 pt-lg-0 pb-2 pb-lg-0"><input type="text" class="form-control" name="name" maxlength="100" value="{{old('name')}}" placeholder="Ad" required></div>
                        <span class="text-danger ps-2 d-none d-lg-block"> * </span>
                    </div>
                    <div class="input-group mb-0 mb-lg-3 align-items-center">
                        <label class="col-lg-3 col-12 align-self-center fw-bold">Soyad : </label>
                        <div class="col-lg-4 col-12 pt-2 pt-lg-0 pb-2 pb-lg-0"><input type="text" class="form-control" name="surname" maxlength="100" value="{{old('surname')}}" placeholder="Soyad" required></div>
                        <span class="text-danger ps-2 d-none d-lg-block"> * </span>
                    </div>
                    <div class="input-group mb-0 mb-lg-3 align-items-center">
                        <label class="col-lg-3 col-12 align-self-center fw-bold">E-Posta : </label>
                        <div class="col-lg-4 col-12 pt-2 pt-lg-0 pb-2 pb-lg-0"><input type="email" class="form-control" name="email" maxlength="225" value="{{old('email')}}" placeholder="E-Posta Adresi" required></div>
                        <span class="text-danger ps-2 d-none d-lg-block"> * </span>
                    </div>
                    <div class="input-group mb-0 mb-lg-3 align-items-center">
                        <label class="col-lg-3 col-12 align-self-center fw-bold">Şifre : </label>
                        <div class="col-lg-4 col-12 pt-2 pt-lg-0 pb-2 pb-lg-0"><input type="password" class="form-control" name="password" minlength="8" maxlength="100" value="" placeholder="Şifre" required></div>
                        <span class="text-danger ps-2 d-none d-lg-block"> * </span>
                    ...
                    <div class="input-group mb-0 mb-lg-3 align-items-center">
                        ...
                        <div class="col-lg-4 col-12 pt-2 pt-lg-0 pb-2 pb-lg-0"><input type="tel" class="form-control" name="phone" minlength="8" maxlength="20" value="{{old('phone')}}" placeholder="Telefon" required></div>
                    </div>
                </div>
            </div>
