...
@section('content')
    <div class="row mt-4 mb-2 me-0 ms-0">
        <div class="col-lg-8 col-6">
            <h6 class="mb-0">Ürün Kategorileri / <small class="text-secondary">Düzenle</small></h6>
    ...
    <div class="m-2 p-4 bg-white rounded shadow-sm">
        <div class="row mb-2 border-bottom border-light border-2">
            <div class="col-lg-4 h5">Kategori Düzenle</div>
                ...
                <div class="tab-pane fade show active" id="info" role="tabpanel">
                    <div class="input-group mb-3 align-items-center">
                        ...
                        <div class="col-lg-4 col-12">
                            <input type="text" class="form-control" name="title" maxlength="100" value="{{$data->title}}" placeholder="Kategori Adı" required>
                        </div>
